...
--
-- Host: 127.0.0.1
-- Generation Time: May 21, 2025 at 02:20 PM
...
CREATE TABLE `brands` (
  ...
  `brands_images` varchar(255) DEFAULT NULL
...
CREATE TABLE `watches` (
  ...
  `type` enum('Luxury','Vintage','Fashion','Sport') DEFAULT NULL,
  `description` text DEFAULT NULL,
  `store_quantity` int(11) DEFAULT 0,
  `purchase_date` datetime DEFAULT current_timestamp(),
  `watches_images` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
ALTER TABLE `cart_details`
  ...
  ADD CONSTRAINT `cart_details_ibfk_2` FOREIGN KEY (`watch_id`) REFERENCES `watches` (`watch_id`);
...
--
ALTER TABLE `watches`
  ADD CONSTRAINT `watches_ibfk_1` FOREIGN KEY (`brand_id`) REFERENCES `brands` (`brand_id`);
COMMIT;
